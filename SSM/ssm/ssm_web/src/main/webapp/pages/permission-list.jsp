						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${permisssionList}" var="permisssion">
										<tr>
											<td><input name="ids" type="checkbox"></td>
											<td>${permisssion.id }</td>
											<td>${permisssion.permissionName }</td>
											<td>${permisssion.url }</td>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permission/findAll.do?id=${permisssion.id}" class="btn bg-olive btn-xs">详情</a>
